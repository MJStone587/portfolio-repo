			...
			<nav className={`navbar ${showNav && "nav_displayed"}`}>
				<div className='navbar_left'>
					<div className='btn_container btn_home_container'>
						<button className='nav_btn btn_home' onClick={() => scrollToDiv(homeRef)}>
							Home
						</button>
					</div>
					<div className='btn_container btn_about_container'>
						<button className='nav_btn btn_about' onClick={() => scrollToDiv(aboutRef)}>
							About
						</button>
					</div>
					<div className='btn_container btn_projects_container'>
						<button className='nav_btn btn_projects' onClick={() => scrollToDiv(projectsRef)}>
							Projects
						</button>
					</div>
					<div className='btn_container btn_contact_container'>
						<button className='nav_btn btn_contact' onClick={() => scrollToDiv(contactRef)}>
							Contact
						</button>
					</div>
				</div>
			...
			<div className='desktop_overlay_container'>
				<ul className='left_overlay_list'>
					...
					<li>
						<a
							aria-label='Linkedin'
							href='https://linkedin.com/in/mark-johnston-740853219'
							target='_blank'
							rel='noreferrer'
						>
							<svg
